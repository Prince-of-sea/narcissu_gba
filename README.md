...
## 動作環境
### コンバータについて
 Windows 10 以降での動作を想定しています。  
 他の環境については検証していません。  
   
 制作/検証に使用した作者のPC環境  
 [![CPU-Z](https://valid.x86.fr/cache/banner/eidarj-2.png)](https://valid.x86.fr/eidarj)  
...
## 基本的な使い方
 ...
 2. [vectorからナルキッソス(nana24.exe)をダウンロード](https://www.vector.co.jp/soft/win95/amuse/se376566.html)し、  
    __展開せずに__`./resources/game_win/`へ配置してください(フォルダがない場合は作成)  
    ※調子悪いとき用の[魚拓はこちら](https://web.archive.org/web/20241128191233fw_/https://ftp.vector.co.jp/37/65/1834/nana24.exe)
...
## 注意事項など
### 他機種でのプレイについて
 「narcissu」は元々NScripter製の作品です。  
 PSP/PSVITA/Switchや、Linux/Android搭載機などのONScripterを利用できる環境でプレイする場合は、  
 本ツールでGBA版へ変換するよりもそちらを使ったほうが素直に動作します。  
 
 また、続編である「[narcissu SIDE 2nd](https://www.vector.co.jp/soft/win95/amuse/se430330.html)」には、初代「narcissu」の内容も収録されています。  
 これらの環境で遊ぶ場合は、こちらを利用する形がおすすめです。  
 
 ちなみに、ゲームデータをONScripter用に変換/最適化する際には、  
 拙作「[ONScripter_Multi_Converter](https://github.com/Prince-of-sea/ONScripter_Multi_Converter)」もありますので、よろしければこちらも合わせてご利用ください。  
...
### 原作と違う点
 ...
 - 「環境設定」→「音楽」の内容が原作のサウンドモードと一部合致しません
...
### 謝辞
 今回のプロジェクトのGBA側実装にあたっては、  
 「[終末の過ごし方 for GBA](https://github.com/akkera102/gbadev-ja-test/tree/main/132_shuumatsu_gba)」のソースコードおよび設計を大いに参考/流用させていただいています。  
 
 私自身、Pythonの経験はあるもののC言語についてはほとんど知識がなく、  
 GBA開発も未経験の状態から今回のプロジェクトを開始しました。  
 そのような中で公開されていた本ソースコードは、実装の手がかりとして非常に大きな助けとなりました。  
 本作品の存在がなければ、そもそも今回のプロジェクトを始めることができなかったと思います。  
 
 当該作品を制作されたakkera102様に、この場を借りて深く感謝いたします。  
...
### お約束
 本ツールの使用において生じた問題や不利益などについて、製作者は一切その責任を負わないものとします。  
 また、それらの問題を他のツールの製作者様やサークル様に問い合わせるのは**絶対にやめてください。**  
